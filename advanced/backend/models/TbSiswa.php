...
class TbSiswa extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['email_akun'], 'exist', 'skipOnError' => true, 'targetClass' => TbAkun::className(), 'targetAttribute' => ['email_akun' => 'email']],
            [['jadwal_id'], 'exist', 'skipOnError' => true, 'targetClass' => TbJadwal::className(), 'targetAttribute' => ['jadwal_id' => 'id']],
    ...
    {
        return $this->hasOne(TbAkun::className(), ['email' => 'email_akun']);
    }
    ...
    {
        return $this->hasOne(TbJadwal::className(), ['id' => 'jadwal_id']);
    }
