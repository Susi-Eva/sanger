...
class SiteController extends Controller
{
    ...
    public function actionDesignreg()
    {
        return $this->render('designreg');
    }

    public function actionCprogramming()
    {
        return $this->render('cprogramming');
    }
    ...
    {
        return $this->render('java');
    }

    public function actionMobilereg()
    {
        return $this->render('mobilereg');
    }
    ...
    public function actionMsoffice()
    {
        return $this->render('msoffice');
    }

    public function actionProgrammingreg()
    {
